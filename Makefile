...
# nlohmann/json（单头文件库）
JSON_INC := libs/nlohmann

# FFmpeg 库模块
FFMPEG_LIBS := -lavcodec -lavformat -lavutil -lswscale -lswresample -lavfilter

CXXFLAGS := -std=c++17 -Wall -Wextra -O2 -D__STDC_CONSTANT_MACROS -I$(FFMPEG_INC) -I$(JSON_INC) -Wno-deprecated-declarations -Wno-stringop-truncation
